...
public class Part1_Circle : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.F))        // Part1: If direction input via GetKey...
        {
            moveX = -1;                     // Part1: Force direction of movement.
        }
        else if (Input.GetKey(KeyCode.H))   // Part1: Else if opposite direction input via GetKey...
        {
            moveX = 1;                      // Part1: Force direction of movement.
        }
